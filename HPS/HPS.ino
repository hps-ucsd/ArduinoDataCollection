...
*/   
  ...
  /* Display the results */
  Serial.print("ax: ");     Serial.print(ax_smoothedVal);
  Serial.print(" ay: ");    Serial.print(ay_smoothedVal);
  Serial.print(" az: ");    Serial.print(az_smoothedVal);
  Serial.print(" -- ");
  Serial.print("gx: ");     Serial.print(gx_smoothedVal);
  Serial.print(" gy: ");    Serial.print(gy_smoothedVal);
  Serial.print(" gz: ");    Serial.print(gz_smoothedVal);
  Serial.print(" -- ");
